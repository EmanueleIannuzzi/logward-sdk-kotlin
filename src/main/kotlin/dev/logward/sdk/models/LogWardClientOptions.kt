 ...
 */
data class LogWardClientOptions(
    val apiUrl: String,
    val apiKey: String,
...
/**
 * DSL builder for LogWardClientOptions
 */
class LogWardClientOptionsBuilder {
    var apiUrl: String = ""
    var apiKey: String = ""
    ...
    fun build(): LogWardClientOptions = LogWardClientOptions(
        apiUrl = apiUrl,
        apiKey = apiKey,
        batchSize = batchSize,
...
/**
 * Create LogWardClient with DSL configuration
 */
fun logWardClient(block: LogWardClientOptionsBuilder.() -> Unit): LogWardClientOptions {
    return LogWardClientOptionsBuilder().apply(block).build()
}
